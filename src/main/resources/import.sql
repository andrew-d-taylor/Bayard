...
--
-- Name: 194436; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194436');


ALTER LARGE OBJECT 194436 OWNER TO bayard_postgres;

--
-- Name: 194437; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194437');


ALTER LARGE OBJECT 194437 OWNER TO bayard_postgres;

--
-- Name: 194438; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194438');


ALTER LARGE OBJECT 194438 OWNER TO bayard_postgres;

--
-- Name: 194439; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194439');


ALTER LARGE OBJECT 194439 OWNER TO bayard_postgres;

--
-- Name: 194440; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194440');


ALTER LARGE OBJECT 194440 OWNER TO bayard_postgres;

--
-- Name: 194441; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194441');


ALTER LARGE OBJECT 194441 OWNER TO bayard_postgres;

--
-- Name: 194442; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194442');


ALTER LARGE OBJECT 194442 OWNER TO bayard_postgres;

--
-- Name: 194443; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194443');


ALTER LARGE OBJECT 194443 OWNER TO bayard_postgres;

--
-- Name: 194444; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194444');


ALTER LARGE OBJECT 194444 OWNER TO bayard_postgres;

--
-- Name: 194445; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('194445');


ALTER LARGE OBJECT 194445 OWNER TO bayard_postgres;

--
-- Name: 198714; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('198714');


ALTER LARGE OBJECT 198714 OWNER TO bayard_postgres;

--
-- Name: 198715; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('198715');


ALTER LARGE OBJECT 198715 OWNER TO bayard_postgres;

--
-- Name: 211853; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('211853');


ALTER LARGE OBJECT 211853 OWNER TO bayard_postgres;

--
-- Name: 211854; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('211854');


ALTER LARGE OBJECT 211854 OWNER TO bayard_postgres;

--
-- Name: 211855; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('211855');


ALTER LARGE OBJECT 211855 OWNER TO bayard_postgres;

--
-- Name: 212214; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('212214');


ALTER LARGE OBJECT 212214 OWNER TO bayard_postgres;

--
-- Name: 212574; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('212574');


ALTER LARGE OBJECT 212574 OWNER TO bayard_postgres;

--
-- Name: 212575; Type: BLOB; Schema: -; Owner: bayard_postgres
--

SELECT pg_catalog.lo_create('212575');


ALTER LARGE OBJECT 212575 OWNER TO bayard_postgres;
...
INSERT INTO event (id, created, deleted, lastmodified, aggregationtype, dateheld, location, name, notes, committee_id) VALUES ('4028bb834eb7d609014eb87ccc57000a', '2015-07-22T21:17:43.383', false, '2016-03-19T12:42:05.601', NULL, '2016-12-11', 'Biddeford, ME', 'Canvassing in Biddeford', 'Canvassers needed', '4028bb834eb7d609014eb87a08d80005');
...
INSERT INTO organization (id, created, deleted, lastmodified, aggregationtype, city, description, email, name, phonenumber, primarycontactname, state, streetaddress, zipcode) VALUES ('4028bb834eb7d609014eb87958ed0004', '2015-07-22T21:13:57.228', false, '2016-03-19T12:41:18.946', NULL, 'Portland', 'The Dems of ME', 'example@mdp.org', 'Maine Democratic Party', '0987654321', 'Buster Keaton', 'ME', '456 Avenue Ave', '04103');
...
SELECT pg_catalog.lo_open('194436', 131072);
SELECT pg_catalog.lowrite(0, '\x465341415344415344415344415344');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('194437', 131072);
SELECT pg_catalog.lowrite(0, '\x465341415344415344415344415344');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('194438', 131072);
SELECT pg_catalog.lowrite(0, '\x6666666666');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('194439', 131072);
SELECT pg_catalog.lowrite(0, '\x6173646661736466');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('194440', 131072);
SELECT pg_catalog.lowrite(0, '\x6173646661736466');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('194441', 131072);
SELECT pg_catalog.lowrite(0, '\x6173646661736466');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('194442', 131072);
SELECT pg_catalog.lowrite(0, '\x61736466');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('194443', 131072);
SELECT pg_catalog.lowrite(0, '\x61736466');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('194444', 131072);
SELECT pg_catalog.lowrite(0, '\x66647361');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('194445', 131072);
SELECT pg_catalog.lowrite(0, '\x6173646173');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('198714', 131072);
SELECT pg_catalog.lowrite(0, '\x4e4f544553');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('198715', 131072);
SELECT pg_catalog.lowrite(0, '\x415344415344');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('211853', 131072);
SELECT pg_catalog.lowrite(0, '\x617364');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('211854', 131072);
SELECT pg_catalog.lowrite(0, '\x61736461736464');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('211855', 131072);
SELECT pg_catalog.lowrite(0, '\x617364');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('212214', 131072);
SELECT pg_catalog.lowrite(0, '\x617364617364617364');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('212574', 131072);
SELECT pg_catalog.lowrite(0, '\x4c');
SELECT pg_catalog.lo_close(0);

SELECT pg_catalog.lo_open('212575', 131072);
SELECT pg_catalog.lowrite(0, '\x4c');
SELECT pg_catalog.lo_close(0);
